 ...
 * explorable before you bring your own key. Live runs are generated fresh by
 * the pipeline in lib/ai/draft.ts and carry their measured token cost.
 */
...
/**
 * The honesty test: BJA Smart Reentry reads like a perfect mission fit for a
 * reentry nonprofit, but its eligible-applicant list is governments only.
 * Granted must say skip.
 */
export const HONESTY_TEST_GRANT_ID = "363588";
